...
acc_A1_train = A1.A1_acc(x_train_A1, y_train_A1, model_A1) # Train model based on the training set (you should fine-tune your model based on validation set.)
...
acc_A2_train = A2.A2_acc(x_train_A2, y_train_A2, model_A2) # Train model based on the training set (you should fine-tune your model based on validation set.)
acc_A2_test = A2.A2_acc(x_test_A2, y_test_A2, model_A2)   # Test model based on the test set.
# ======================================================================================================================
# Task B1
model_B1 = B1.B1_CNN(x_train_B1, x_val_B1, y_train_B1, y_val_B1)
acc_B1_train = B1.B1_acc(x_train_B1, y_train_B1, model_B1)
acc_B1_test = B1.B1_acc(x_test_B1, y_test_B1, model_B1)


# ======================================================================================================================
# Task B2
model_B2 = B2.B2_CNN(x_train_B2, x_val_B2, y_train_B2, y_val_B2)
acc_B2_train = B2.B2_acc(x_train_B2, y_train_B2, model_B2)
acc_B2_test = B2.B2_acc(x_test_B2, y_test_B2, model_B2)
